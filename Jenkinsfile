...
bat curl -u "pkuma343:ponkmonk_138202" "https://api.github.com/repos/pkuma343/MySpringBootApp/statuses/$GIT_COMMIT" -H "Content-Type: application/json" -X POST -d "{\"state\": \"success\",\"context\": \"continuous-integration/java/unit-test-execution\", \"description\": \"Jenkins\", \"target_url\": $env.BUILD_URL}"
